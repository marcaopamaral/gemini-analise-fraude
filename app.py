...
if not st.session_state.messages:
    ...
    if is_demo_df:
        welcome_message = "Olá! Eu sou um agente desenvolvido por Marcos para o desafio I2A2. Para testes uso dados de demonstração criado por mim. Se quiser outro arquivo, me informe o caminho pelo comando **Análise este arquivo CSV:** `https://link-para-o-seu-arquivo.csv`."
    else:
        welcome_message = "Olá! Eu sou um agente desenvolvido por Marcos para o desafio I2A2. Uso dados do arquivo `creditcard.csv`. Se quiser outro arquivo, me informe o caminho pelo comando **Análise este arquivo CSV:** `https://link-para-o-seu-arquivo.csv`."
