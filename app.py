...
def run_conversation(prompt: str):
    ...
    try:
        ...
        if candidate["content"]["parts"] and "functionCall" in candidate["content"]["parts"][0]:
            ...
            # --- Bloco para a ferramenta 'carregar_dados' ---
            ...
            # --- Fim do bloco ---
                ...
                with st.spinner("🧠 Analisando conclusões..."):
                    # A ferramenta em si não faz nada além de retornar esta string para o modelo continuar a conversa
            ...
            if not response_2:
                # Se a segunda chamada falhar, limpa as últimas três mensagens do histórico
...
if not st.session_state.messages:
    ...
    # CORREÇÃO DE INDENTAÇÃO APLICADA E USO DA TAG HTML <br> PARA GARANTIR AS 4 LINHAS
    if is_demo_df:
